...
@Composable
fun MyDoubtScreen(navController: NavController){
    var question by remember { mutableStateOf<List<QFormat>>(mutableListOf()) }
    var message by remember { mutableStateOf("...Loading")}
        ...
        LaunchedEffect(Unit) {
            try {
                val getmyque = RetroInstance.api1.getquestion(Current_User.Rollno).body()

                if (getmyque?.success == true) {
                    question = getmyque.questions
                } else {
        ...
        Column(
                            ...
                            Box(
                                modifier = Modifier.fillMaxWidth()
                                    ...
                                    .clickable{
                                        ...
                                        navController.navigate(Screens.MyAnswerScreen.route)
                                    }
                            ) {
                                Column {
                                    Text(
            ...
            } else if (message == "...Loading" && question.size == 0) {
                Column(
                    modifier = Modifier.fillMaxSize()
